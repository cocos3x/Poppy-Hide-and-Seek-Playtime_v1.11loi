...
namespace com.adjust.sdk
{
    public class Adjust : MonoBehaviour
    {
        ...
        private void Awake()
        {
            com.adjust.sdk.AdjustConfig val_2 = new com.adjust.sdk.AdjustConfig(appToken:  this.appToken, environment:  1, allowSuppressLogLevel:  (this.logLevel == 7) ? 1 : 0);
            val_2.setLogLevel(logLevel:  this.logLevel);
            val_2.setSendInBackground(sendInBackground:  this.sendInBackground);
            val_2.setEventBufferingEnabled(eventBufferingEnabled:  this.eventBuffering);
            .launchDeferredDeeplink = this.launchDeferredDeeplink;
            val_2.setDelayStart(delayStart:  5.5);
            com.adjust.sdk.Adjust.start(adjustConfig:  val_2);
            com.adjust.sdk.Adjust.addSessionCallbackParameter(key:  "user_id", value:  UnityEngine.SystemInfo.deviceUniqueIdentifier);
            UnityEngine.Debug.LogWarning(message:  "Start adjust delay 5.5s !");
        }
