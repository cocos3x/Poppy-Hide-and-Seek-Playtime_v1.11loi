...
private sealed class JSONClass.<get_Childs>d__14 : IEnumerable<com.adjust.sdk.JSONNode>, IEnumerable, IEnumerator<com.adjust.sdk.JSONNode>, IEnumerator, IDisposable
{
    ...
    private bool MoveNext()
    {
        ...
        val_7 = this.<>7__wrap1;
        mem[1152921507332407904] = val_2;
        this.<>7__wrap1 = val_3;
        mem[1152921507332407888] = val_4;
        this.<>1__state = -3;
        goto label_5;
        label_1:
        val_7 = this.<>7__wrap1;
        ...
        if((val_7 & 1) != 0)
        {
                val_8 = 1;
            this.<>1__state = val_8;
            this.<>2__current = 1152921507331287712;
            return (bool)val_8;
        }
    ...
    {
        this.<>1__state = 0;
        this.<>7__wrap1.Add(driver:  public System.Void Dictionary.Enumerator<System.String, com.adjust.sdk.JSONNode>::Dispose(), rectTransform:  null, drivenProperties:  null);
    }
