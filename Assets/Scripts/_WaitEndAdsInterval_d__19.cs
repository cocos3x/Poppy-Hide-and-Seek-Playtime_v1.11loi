using UnityEngine;
private sealed class AdManager.<WaitEndAdsInterval>d__19 : IEnumerator<object>, IEnumerator, IDisposable
{
    // Fields
    ...
    // Methods
    public AdManager.<WaitEndAdsInterval>d__19(int <>1__state)
    {
